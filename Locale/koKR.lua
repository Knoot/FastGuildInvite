...
local L = {
	["FAQ"] = {
		["help"] = {
			["blacklist"] = "/fgi blacklist <이름> - <이유> - 블랙 리스트에 플레이어 추가",
			["factorySettings"] = "/fgi factorySettings - 전체 애드온 데이터베이스 재설정",
			["filter"] = "LMB - 사용함/사용안함\n PMM - 수정\nShift+LMB - 이동\n\n",
			["filterTooltip"] = "필터 이름:%s\n상태:%s\n이름 필터:%s\n레벨 범위:%s\n 이름의 중복 필터:%u:%u\n 클래스:%s\n특징::%s\n 필터 응답 수:%u",
			["help2"] = "/fgi help2 - 명령어와 전송하십시요 \"!\"",
			["invite"] = "/fgi invite - 대기열에서 첫 번째 플레이어 초대",
			["minimap"] = "LMB - 초대\n PM - 기본 창을 엽니다.\nShift+LMB-일시 중지/계속\n\n 변경:%u\n 진행:%s",
			["nextSearch"] = "/fgi nextSearch - 다음 스캔 실행",
		...
		["help2"] = {
			["blacklistAdd"] = "!blacklistAdd <이름> - <이유> - 블랙 리스트에 플레이어를 추가합니다.",
			["blacklistDelete"] = "!blacklistDelete <이름> - <이유> -블랙 리스트에서 플레이어를 제거합니다.",
			["blacklistGetList"] = "!blacklistGetList - 블랙 리스트에 있는 플레이어 목록 가져오기",
			["commandList"] = "다음 명령을 사용할 수 있습니다.",
			["fgi"] = "!fgi - 사용 가능한 명령 목록",
			["intro"] = "|cff00ff96접두사와 명령어 \"|cffff0000!|r|cff00ff96\" 있는 명령은 애드온이 설치되지 않은 관리자를 위해 작성되며 이 명령은 관리자 채널에서만 사용할 수 있습니다.|r",
		},
	},
	["interface"] = {
		["defaultReason"] = "이유 없음",
		...
		["Да"] = "예",
		["Данные для синхронизации"] = "동기화 데이터",
		...
		["Другая помощь"] = "기타 도움",
		["Запоминать всех игроков"] = "모든 플레이어 기억",
		["Запускать в фоновом режиме"] = "백그라운드에서 실행",
		["Игнорировать"] = "무시",
		["Игрок %s добавлен в черный список."] = "플레이어 %s은 (는) 블랙리스트에 추가됩니다.",
		["Игрок %s найденный в черном списке, находится в вашей гильдии!"] = "블랙리스트에 있는 플레이어 %s 길드입니다!",
		["Игрок %s хочет синхронизировать %s.\nРазрешить?"] = "플레이어 %s님이 %s 을(를) 동기화 하고자합니다. 허용 하시겠습니까?",
		["Игрок для синхронизации"] = "플레이어  동기화",
		...
		["Настройка сообщений, подсказка"] = "자동 교체. NAME은 메시지가 전송 된 플레이어의 이름입니다. GUILD는 길드의 이름입니다.",
		["Настройки"] = "설정",
		...
		["Перевод"] = "번역",
		["Подтверждение отправки данных синхронизации"] = "동기화 데이터 전송 확인",
		["Поле может содержать только буквы"] = "필드는 문자만 포함 할 수 있습니다.",
		["Пользовательский список"] = "사용자 지정 목록",
		["Предпросмотр: %s"] = "미리 보기: %s",
		["Пригласить"] = "초대",
		["Пригласить: %d"] = "초대: %d",
		["Причина"] = "이유",
		...
		["Сохранить"] = "저장",
		["Список отправленных приглашений"] = "보낸 초대 목록",
		["Список фильтров"] = "필터 목록",
		...
		["tooltip"] = {
			...
			["Записывать игрока в базу данных даже если приглашение не было отправлено"] = "초대장이 전송되지 않은 경우에도 데이터베이스에 플레이어 쓰기",
			["Записывать игрока в базу данных сразу после нахождения"] = "플레이어를 찾은 후 바로 데이터베이스에 넣습니다.",
			["Запускать поиск в фоновом режиме"] = "백그라운드 검색 실행",
			["Использовать пользовательский список запросов"] = "사용자 지정 맞춤 목록 사용",
			["Количество уровней сканируемых за один раз"] = "한 번에 스캔 할 레벨 수",
			["Назначить клавишу для приглашения"] = "초대장에 키 지정",
			["Назначить клавишу следующего поиска"] = "다음 검색 키 할당",
		...
		["clearDBtimes"] = {
			...
			["1 неделя"] = "1주",
			["6 месяцев"] = "6개월",
			["Время запоминания игрока"] = "플레이어 기억하는 시간",
			["Отключить"] = "사용 안 함",
		},
		["synchType"] = {
			["Список приглашенных"] = "초대 목록",
			["Черный список"] = "블랙 리스트",
		},
		["synchState"] = {
			["Данные для синхронизации не выбраны"] = "선택된 동기화 데이터가 없습니다",
			["Данные синхронизированы с игроком %s."] = "플레이어와 동기화된 데이터 %s.",
			["Запрос синхронизации у: %s. %d"] = "동기화 요청 : %s. %d",
			["Игрок для синхронизации не выбран"] = "동기화할 플레이어가 선택되지 않았습니다.",
			["Начало синхронизации"] = "동기화 시작",
			["Ошибка типа синхронизации"] = "동기화 유형 오류",
			["Превышен лимит ожидания ответа"] = "응답 대기 시간 제한 초과",
			["Синхронизация с %s.\n %d/%d"] = "동기화 %s.\n %d/%d",
		},
	},
	["SYSTEM"] = {
