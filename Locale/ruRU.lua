...
local L = {
	FAQ = {
		help = {
			...
			blacklist = "/fgi blacklist <Имя> - <Причина> - Добавить игрока в черный список",
	...
	interface = {
		...
		["Список отправленных приглашений"] = "Список отправленных приглашений",
		["Подтверждение отправки данных синхронизации"] = "Подтверждение отправки данных синхронизации",
		...
		["Сбросить"] = "Сбросить",
		["Настройка сообщений, подсказка"] = [[Автоматическая замена.
